const EmployeeReview = () => {
  return (
    <div>
      <h1 className="text-center text-3xl font-bold m-5">Employee Review</h1>
        ...
        <div>
          <div className="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800">
            ...
            <div className="p-4 lg:space-y-2 text-sm dark:text-gray-600">
              ...
              <p>
              I have consistently met and often exceeded my performance goals, contributing significantly to the teams success.
              </p>
            </div>
          </div>
        </div>
